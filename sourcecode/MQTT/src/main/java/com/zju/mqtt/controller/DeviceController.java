...
public class DeviceController {
    ...
    public List<Integer> mountFirst(Integer id)
    {
    ...
    public  List<Integer> mountSecond(Integer id)
    {
        List<Integer> list = new ArrayList<>();
    ...
    public List<Integer> mountThird(Integer id)
    {
        List<Integer> list = new ArrayList<>();
    ...
    public List<Message> getMessage(@RequestParam Integer id,@RequestParam String device_name,@RequestParam String device_id,@RequestParam String option,@RequestParam String order) {
...
// 执行查询
    ...
    public Pair<Integer,List<Message>> getMessage(Integer userid, Integer device_id)
    {
    ...
    public List<Device> getMessage(Integer userid)
    {
        return deviceMapper.findUserDevice(userid);
    }

    @RequestMapping(value = "/editDevice", method = RequestMethod.POST)
    public Integer editDevice(Integer device_id, String device_type, String device_name, String device_desc)
    {
    ...
    public Integer AddDevice(Integer user_id, String device_name, String device_type, String device_des)
    {
        QueryWrapper<Device> queryWrapper1 = new QueryWrapper<>();
    ...
    public Integer delDevice(Integer device_id)
    {
